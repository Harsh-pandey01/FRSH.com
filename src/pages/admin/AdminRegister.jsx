          ...
          <div className="px-3">
            ...
            >
              <div className="relative">
                ...
                <input
                  className="w-full text-text text-sm mt-1 font-inter border border-border px-2 py-1.5 rounded-md outline-none focus:border-bluish"
                  type="text"
                  id="userEmail"
                  name="userEmail"
              ...
              <div className="relative">
                ...
                <input
                  autoComplete="off"
                  className="w-full text-sm text-text mt-1 border border-border px-2 py-1.5 rounded-md outline-none focus:border-bluish"
                  type="text"
                  id="password"
                  name="password"
              ...
              <div className="relative">
                ...
                <div className="mt-1">
                  <div className="group w-full flex items-center px-2 gap-2 font-inter text-sm border border-border rounded-md transition-colors focus-within:border-bluish">
                    <input
                      className="flex-1 text-text font-inter text-sm py-1.5 rounded-md outline-none bg-transparent"
                      type={
